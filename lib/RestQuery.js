...
var cleanResultOfSensitiveUserInfo = function cleanResultOfSensitiveUserInfo(result, auth, config) {
  ...
  try {
    for (var _iterator7 = config.userSensitiveFields[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
...
RestQuery.prototype.runFind = function () {
  ...
  return this.config.database.find(this.className, this.restWhere, findOptions).then(function (results) {
    ...
    if (_this10.redirectClassName) {
      ...
      try {
        for (var _iterator9 = results[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
          var r = _step9.value;
...
function includePath(config, auth, response, path) {
  ...
  try {
    for (var _iterator10 = pointers[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
      var pointer = _step10.value;
  ...
  return Promise.all(queryPromises).then(function (responses) {
    var replace = responses.reduce(function (replace, includeResponse) {
      ...
      try {
        for (var _iterator11 = includeResponse.results[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
...
function findObjectWithKey(root, key) {
  ...
  if (root instanceof Array) {
    ...
    try {
      for (var _iterator13 = root[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
